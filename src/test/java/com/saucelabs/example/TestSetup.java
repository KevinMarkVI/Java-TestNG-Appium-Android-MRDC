...
public class TestSetup {
  ...
  private AndroidDriver createDriver(String deviceId, String methodName) throws MalformedURLException {
    ...
    public void twoPlusTwoOperation(String deviceId, Method method) throws MalformedURLException {

    	AndroidDriver driver = createDriver(deviceId, method.getName());
